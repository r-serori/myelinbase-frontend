...
import { DocumentStatus, STATUS_FILTER_OPTIONS, getDocumentDisplayLabel } from "@/lib/schemas/document";
                ...
                <DropdownList id="statusDropdownList" size="sm">
                  {STATUS_FILTER_OPTIONS.map((option) => (
                    <DropdownItem
                      ...
                      onMouseDown={(e) => {
                        e.preventDefault();
                        actions.setStatusFilter(option.value as DocumentStatus);
              ...
              <div className="flex items-center gap-2">
                ...
                >
                  <Input
                    ...
                    onChange={(e) => actions.setIsUntaggedInput(e.target.checked)}
                  />
