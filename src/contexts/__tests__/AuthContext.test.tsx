...
describe("AuthContext", () => {
  beforeEach(() => {
    ...
    (AmplifyAuth.getCurrentUser as any).mockResolvedValue({
      userId: "user-123",
      username: "testuser",
    });
    (AmplifyAuth.fetchUserAttributes as any).mockResolvedValue({
  ...
  it("handles not signed in state", async () => {
    (AmplifyAuth.getCurrentUser as any).mockRejectedValue(new Error("Not signed in"));
